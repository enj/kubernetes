...
func (s *ServerRunOptions) Flags() (fss cliflag.NamedFlagSets) {
	...
	fs.StringVar(&s.KubeletConfig.TLS.CertFile, "kubelet-client-certificate", s.KubeletConfig.TLS.CertFile,
		"Path to a client cert file for TLS.")

	fs.StringVar(&s.KubeletConfig.TLS.KeyFile, "kubelet-client-key", s.KubeletConfig.TLS.KeyFile,
		"Path to a client key file for TLS.")

	fs.StringVar(&s.KubeletConfig.TLS.CAFile, "kubelet-certificate-authority", s.KubeletConfig.TLS.CAFile,
