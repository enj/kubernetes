...
type PolicyRule struct {
	...
	LabelSelector map[string]string `json:"labelSelector,omitempty" protobuf:"bytes,7,opt,name=labelSelector"`
	FieldSelector map[string]string `json:"fieldSelector,omitempty" protobuf:"bytes,8,opt,name=fieldSelector"`
}
