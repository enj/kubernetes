...
func (in *ExecConfig) DeepCopyInto(out *ExecConfig) {
	*out = *in
	...
	in.PermissionProvider.DeepCopyInto(&out.PermissionProvider)
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ExecPermissionProvider) DeepCopyInto(out *ExecPermissionProvider) {
	*out = *in
	if in.Allowlist != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ExecPermissionProvider.
func (in *ExecPermissionProvider) DeepCopy() *ExecPermissionProvider {
	if in == nil {
		return nil
	}
	out := new(ExecPermissionProvider)
	in.DeepCopyInto(out)
	return out
}
