...
func (b *ConditionApplyConfiguration) WithExpression(value string) *ConditionApplyConfiguration {
	b.Expression = &value
	return b
}
...
func (b *ConditionApplyConfiguration) WithReason(value v1.StatusReason) *ConditionApplyConfiguration {
	b.Reason = &value
	return b
}
...
func (b *ConditionApplyConfiguration) WithMessageExpression(value string) *ConditionApplyConfiguration {
