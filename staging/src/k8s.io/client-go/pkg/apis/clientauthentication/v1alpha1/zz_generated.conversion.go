...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*ProxyConfig)(nil), (*clientauthentication.ProxyConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_ProxyConfig_To_clientauthentication_ProxyConfig(a.(*ProxyConfig), b.(*clientauthentication.ProxyConfig), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*clientauthentication.ProxyConfig)(nil), (*ProxyConfig)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_clientauthentication_ProxyConfig_To_v1alpha1_ProxyConfig(a.(*clientauthentication.ProxyConfig), b.(*ProxyConfig), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1alpha1_ExecCredentialStatus_To_clientauthentication_ExecCredentialStatus(in *ExecCredentialStatus, out *clientauthentication.ExecCredentialStatus, s conversion.Scope) error {
	...
	out.ProxyConfig = (*clientauthentication.ProxyConfig)(unsafe.Pointer(in.ProxyConfig))
	return nil
}
...
func autoConvert_v1alpha1_ProxyConfig_To_clientauthentication_ProxyConfig(in *ProxyConfig, out *clientauthentication.ProxyConfig, s conversion.Scope) error {
	out.Port = in.Port
	out.CertificateAuthorityData = *(*[]byte)(unsafe.Pointer(&in.CertificateAuthorityData))
	return nil
}

// Convert_v1alpha1_ProxyConfig_To_clientauthentication_ProxyConfig is an autogenerated conversion function.
func Convert_v1alpha1_ProxyConfig_To_clientauthentication_ProxyConfig(in *ProxyConfig, out *clientauthentication.ProxyConfig, s conversion.Scope) error {
	return autoConvert_v1alpha1_ProxyConfig_To_clientauthentication_ProxyConfig(in, out, s)
}

func autoConvert_clientauthentication_ProxyConfig_To_v1alpha1_ProxyConfig(in *clientauthentication.ProxyConfig, out *ProxyConfig, s conversion.Scope) error {
	out.Port = in.Port
	out.CertificateAuthorityData = *(*[]byte)(unsafe.Pointer(&in.CertificateAuthorityData))
	return nil
}

// Convert_clientauthentication_ProxyConfig_To_v1alpha1_ProxyConfig is an autogenerated conversion function.
func Convert_clientauthentication_ProxyConfig_To_v1alpha1_ProxyConfig(in *clientauthentication.ProxyConfig, out *ProxyConfig, s conversion.Scope) error {
	return autoConvert_clientauthentication_ProxyConfig_To_v1alpha1_ProxyConfig(in, out, s)
}
