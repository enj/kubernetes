...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("auditsinks"):
		...
		// Group=authentication.k8s.io, Version=v1alpha1
	case authenticationv1alpha1.SchemeGroupVersion.WithResource("authenticationconfigs"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Authentication().V1alpha1().AuthenticationConfigs().Informer()}, nil
