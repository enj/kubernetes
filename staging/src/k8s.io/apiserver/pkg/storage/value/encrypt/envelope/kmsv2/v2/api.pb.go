...
const (
	...
	// (referred to as the seed throughout the code) that is fed into HKDF expand.  SHA256 as the hash alogirthm
...
type EncryptedObject struct {
	...
	// EncryptedDEKSource is the ciphertext of the source of the DEK used to encrypte the data stored in encryptedData.
