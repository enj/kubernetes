...
func (ca *CertificateAuthority) Sign(crDER []byte, policy SigningPolicy, usages []capi.KeyUsage, notAfter metav1.Time) ([]byte, error) {
	...
	if err := policy.apply(tmpl, usages, ca.Certificate.NotAfter, notAfter.Time); err != nil {
		return nil, err
	}
